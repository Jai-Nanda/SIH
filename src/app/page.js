...
//     const authStatus = localStorage.getItem('Fasalmitr _authenticated');
//     if (authStatus === 'true') {
...
//     localStorage.setItem('Fasalmitr _authenticated', 'true');
//     setIsAuthenticated(true);
//   };
...
//   const handleSignOut = () => {
//     localStorage.removeItem('Fasalmitr _authenticated');
...
//           </div>
//           <h2 className="text-2xl font-bold text-gray-900 mb-2">Fasalmitr </h2>
